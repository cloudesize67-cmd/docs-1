...
export const sidebarContent: ISidebarContent = [
  ...
  },
  {
    title: "AI",
    slug: "/ai",
    content: [makePage("Railway Agent", "ai"), makePage("Agent skills", "ai"), makePage("Claude Code overview", "ai"), makePage("Claude Code plugin", "ai"), makePage("MCP server", "ai"), makePage("Remote MCP server", "ai")],
  },
  {
